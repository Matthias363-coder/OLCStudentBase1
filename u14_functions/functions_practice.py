...
area1 = area_triangle(10, 50)
area2 = area_triangle(30, 75)
area3 = area_triangle(55, 11)
area4 = area_triangle(44, 58)
area5 = area_triangle(88, 10)

# find the total area of all these triangle
...
def check_valid_num(num,base):
    for i in num:
        if base == "2" and i not in "01":
            ...
            return False
        elif base == "16" and i.upper() not in "0123456789ABCDEF":
            return False
    
    return True

print(check_valid_num("10110", "2"))
print(check_valid_num("19A", "16"))
print(check_valid_num("19G", "16"))
print(check_valid_num("1201", "2"))
