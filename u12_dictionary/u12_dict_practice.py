...
for name, score in students.items():
    if score > maxscore:
        maxscore = score
        maxstudent = name
print(f"The highest score is {maxscore}, name is {maxstudent}")
...
for name, score in students.items():
    ...
    if score > 80:
        counterAbove80 += 1
        print(f"Above 80 Student: {name}")

print(f"The number of students who got higher than 80 is {counterAbove80}")
